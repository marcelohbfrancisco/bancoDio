package edu.baco.conta.contajovem;
import edu.baco.conta.Conta;

public class ContaJovem extends Conta implements edu.baco.interfaces.EmprestimoHabilitado {
    public ContaJovem(int agencia, int numero, double saldo, double limite, double investimento, String nome, String sobrenome, String telefone, int type, boolean emprestimo) {
